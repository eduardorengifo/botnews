...
class RppTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $postAuthor->setName('RPP');
        $postAuthor->setLogo( $authorLogo );
        $postAuthor->setUrl( 'http://rpp.pe' );

        $postThumbnail = new Image('https://e.rpp-noticias.io/medium/2017/12/28/portada_010001.jpg');
        ...
        $post->setMedia([
        	new Image('https://e.rpp-noticias.io/medium/2017/12/28/portada_010001.jpg'),
        	new Image('https://e.rpp-noticias.io/medium/2017/12/28/543763598d37b4432efjpg.jpg'),
        	new Image('https://e.rpp-noticias.io/medium/2017/12/28/543765img-odotras-20171201-170908-imagenes-lv-otras-fuentes-captura2-3-kn0h-u433332673231hab-992x558lavanguardia-webjpg.JPG')
        ]);
        $this->post = $post;
    }
