...
class La10Test extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $postAuthor->setUrl( 'http://la10.rpp.pe' );

        $postThumbnail = new Image('https://e.rpp-noticias.io/medium/2017/12/20/portada_485248.jpg');
        ...
        $post->setDescription('El comité de Apelación de la FIFA le redujo la sanción al delantero peruano y así lo informaron en diversos países.');
        ...
        $post->setMedia([
            new Image('https://e.rpp-noticias.io/medium/2017/12/20/portada_485248.jpg'),
            new Image('https://e.rpp-noticias.io/medium/2017/12/20/539700wgaesgewrjpg.jpg'),
            new Image('https://e.rpp-noticias.io/medium/2017/12/20/539699rehgerhgerwhgjpg.jpg'),
            new Image('https://e.rpp-noticias.io/medium/2017/12/20/539698erghergjpg.jpg'),
            new Image('https://e.rpp-noticias.io/medium/2017/12/20/539697erhgejpg.jpg'),
            new Image('https://e.rpp-noticias.io/medium/2017/12/20/539696trhresdfjpg.jpg'),
            new Image('https://e.rpp-noticias.io/medium/2017/12/20/539695rehgerfjpg.jpg'),
            new Image('https://e.rpp-noticias.io/medium/2017/12/20/539694wgeragjpg.jpg')
        ]);
        $this->post = $post;
    }
